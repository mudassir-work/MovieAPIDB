...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLifecycleLivedataLibraryAccessors extends SubDependencyFactory {
        private final AndroidxLifecycleLivedataCoreLibraryAccessors laccForAndroidxLifecycleLivedataCoreLibraryAccessors = new AndroidxLifecycleLivedataCoreLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.lifecycle.livedata.core</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxLifecycleLivedataCoreLibraryAccessors getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxLifecycleLivedataCoreLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxLifecycleLivedataCoreLibraryAccessors extends SubDependencyFactory {

        public AndroidxLifecycleLivedataCoreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ktx</b> with <b>androidx.lifecycle:lifecycle-livedata-core-ktx</b> coordinates and
         * with version reference <b>lifecycleLivedataCoreKtx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getKtx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.lifecycle.livedata.core.ktx");
        }
    ...
    public static class LifecycleLivedataLibraryAccessors extends SubDependencyFactory {
        private final LifecycleLivedataCoreLibraryAccessors laccForLifecycleLivedataCoreLibraryAccessors = new LifecycleLivedataCoreLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>lifecycle.livedata.core</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public LifecycleLivedataCoreLibraryAccessors getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForLifecycleLivedataCoreLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class LifecycleLivedataCoreLibraryAccessors extends SubDependencyFactory {

        public LifecycleLivedataCoreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ktx</b> with <b>androidx.lifecycle:lifecycle-livedata-core-ktx</b> coordinates and
         * with version reference <b>lifecycleLivedataCoreKtxVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getKtx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("lifecycle.livedata.core.ktx");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>lifecycleLivedataCoreKtx</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLifecycleLivedataCoreKtx() { return getVersion("lifecycleLivedataCoreKtx"); }

        /**
         * Version alias <b>lifecycleLivedataCoreKtxVersion</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLifecycleLivedataCoreKtxVersion() { return getVersion("lifecycleLivedataCoreKtxVersion"); }
